...
public class AuthentificationREST {
    ...
    public ResponseEntity auth(){
        ...
        try {
            URL url = new URL("https://api.login.yahoo.com/oauth2/request_auth?client_id=dj0yJmk9eldSMWJBZzRIUDBLJmQ9WVdrOVNYbFpXVTB6TlhrbWNHbzlNQT09JnM9Y29uc3VtZXJzZWNyZXQmc3Y9MCZ4PTk0&response_type=code&redirect_uri=https://tpdl-back.herokuapp.com/test/ok");
